...
namespace eShopSolution.Application.Catalog.Product
{
    public class ManageProductService : IManageProductService
    {
        ...
        public async Task<ProductImageViewModel> GetImageById(int imageId)
        {
            ...
            {
                throw new EShopException("can not find image");
            }
        ...
        public async Task<int> RemoveImage(int imageId)
        {
            ...
            if (productImage == null)
            {
                throw new EShopException("can not find an image");
        ...
        public async Task<int> Update(ProductUpdateRequest request)
        {
            ...
            if (product == null||productTranslations==null) throw new EShopException("Can not find a product");
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null) throw new EShopException("Can not find a product");
